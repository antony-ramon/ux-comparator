...
puts "LET'S SEED THIS UX COMPARATOR !"
...
puts "            Companies saved!"



puts"Creating Typologies.."
...
puts "    Typologies created!"

puts"        Saving typologies..."
...
puts "            Indicators saved!"



puts "Creating Messages..."

message_001 = Message.new(sender_id: 1, content: 'Did you see how our competitors handle this? Good ideas I think!', receiver_id: 2, typology: typology_016)
message_002 = Message.new(sender_id: 2, content: 'You\'re right, should we do the same?', receiver_id: 1, typology: typology_016)
message_003 = Message.new(sender_id: 1, content: 'Yes, go!', receiver_id: 2, typology: typology_016)
message_004 = Message.new(sender_id: 2, content: 'OK done!', receiver_id: 1, typology: typology_016)
message_005 = Message.new(sender_id: 1, content: 'Hi, why are we so slow to validate accounts?', receiver_id: 3, typology: typology_004)
message_006 = Message.new(sender_id: 1, content: '(maybe staff?)', receiver_id: 3, typology: typology_004)
message_007 = Message.new(sender_id: 5, content: 'Should we send SMS to our customers as well before they\'re charged?', receiver_id: 7, typology: typology_024)
message_008 = Message.new(sender_id: 7, content: 'I\'ll check it, might be a good idea to prevent contacts', receiver_id: 5, typology: typology_024)
message_009 = Message.new(sender_id: 6, content: 'Wow, we\'re the only one to handle of contrat that way, should we review it?', receiver_id: 8, typology: typology_026)
message_010 = Message.new(sender_id: 7, content: 'We can\'t add an item directly from the cart? Why is that?', receiver_id: 9, typology: typology_033)
message_011 = Message.new(sender_id: 10, content: 'That many clicks to checkout? Why?', receiver_id: 11, typology: typology_036)
message_012 = Message.new(sender_id: 11, content: 'Yep, we\'re working on it. ETA next week. Comes from an interference with the latest feature we shipped.', receiver_id: 10, typology: typology_036)
message_013 = Message.new(sender_id: 13, content: 'So we don\'t answer the phone now? Seriously?', receiver_id: 15, typology: typology_044)
message_014 = Message.new(sender_id: 16, content: 'Interesting, it seems we could improve the process to start our vehicles, it confirms an email we got last week from a customer', receiver_id: 14, typology: typology_053)
message_015 = Message.new(sender_id: 14, content: 'I remember. I\'ll see if it\'s possible and will get back to you.', receiver_id: 16, typology: typology_053)
message_016 = Message.new(sender_id: 17, content: 'Why aren\'t we reachable via social media?', receiver_id: 19, typology: typology_060)
message_017 = Message.new(sender_id: 20, content: 'We need to improve our response delay on social media. Can you take care of it?', receiver_id: 18, typology: typology_063)

puts "    Messages created!"

puts "        Saving messages..."
